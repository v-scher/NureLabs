package ua.khture.scherbyna;

import java.awt.Toolkit;
import java.util.Map;
import java.util.TreeMap;

import ua.khture.scherbyna.containers.Coeff;
import ua.khture.scherbyna.containers.ExpertRates;
import ua.khture.scherbyna.containers.Worker;
import ua.khture.scherbyna.ui.AddCriteriaFrame;
import ua.khture.scherbyna.ui.CorrectOrExitDialog;
import ua.khture.scherbyna.ui.Window;
...
public class WindowManager {
	...
	public static void showCoeffsPane(Map<Integer, Coeff> _coeffs)
	{
		...
		String text = "Суммарная МВО: " + doubleToString(paymentCoef, 3) + ", к оплате " + worker.name + ": " + doubleToString(paymentCoef * worker.payment, 3);
	...
	public static void showExpertsPane(ExpertRates _expertRates)
	{
		...
		{
			String[][] expContent = {{"ФИО эксперта"}, {""}};
	...
	public static void onBackToWorkersButtonClicked(String[][] _content) 
	{
		...
		{
			CorrectOrExitDialog dialog = new CorrectOrExitDialog(m_wnd, "Если выйти, изменения не сохранятся", "Все равно выйти", "Отмена");
