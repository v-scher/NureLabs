...
import static ua.nure.shcherbatenko.course5.TSSA.lab2.Rankings.*;
import static ua.nure.shcherbatenko.course5.TSSA.lab2.PairComparing.*;
...
public class Main {
    ...
    public static void printRanks(int[][] groupRanks, double[] avgRanks, int[] ranks) {
