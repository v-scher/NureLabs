  ...
  MenuFrame1(String title) {
    ...
    ActionListener handler = new ActionListener(){
    	public void actionPerformed(ActionEvent ae) { 
    	     ...
    	     if(arg.equals("New...")) { 
    	        msg += "New."; 
    	        SampleDialog d = new SampleDialog(thisFrame, "New Dialog Box"); 
    	        d.setVisible(true); 
    	      } 
    ...
    ItemListener handler1 = new ItemListener() {
    	public void itemStateChanged(ItemEvent ie) { 
    	      repaint(); 
    	  }
	};
    debug.addItemListener(handler1); 
    test.addItemListener(handler1); 
