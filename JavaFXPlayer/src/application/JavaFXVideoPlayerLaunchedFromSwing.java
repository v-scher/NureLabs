...
class SceneGenerator {
  ...
  public Scene createScene() {
    ...
    final File dir = new File("C:\\Scher\\Downloads\\MoodMusicTestMP3\\little");
    ...
    for (String file : dir.list(new FilenameFilter() {
      @Override public boolean accept(File dir, String name) {
    	...
    	MediaPlayer player = createPlayer("file:///" + (dir + "\\" + file).replace("\\", "/").replaceAll(" ", "%20"));
    	if( player != null)
    		players.add(player);
    }
    if (players.isEmpty()) {
